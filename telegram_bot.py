...
def command_ai(chat_id):
    ...
    try:
        ...
        answer = ask_gemini(
            ...
            "market direction using price "
            "action, trend, momentum, volume "
            "and risk management. "

            "Do not place or recommend a "
            "live trade."
        )
